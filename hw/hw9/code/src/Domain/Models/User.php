...
class User
{
    ...
    public static function getAllUsersFromStorage(?int $limit = null): array
    {
        ...
        foreach ($result as $item) {
            $user = new User($item['id_user'], $item['user_name'], $item['user_lastname'], $item['user_birthday_timestamp'], $item['rank']);
            $users[] = $user;
        }       
    ...
    public function setParamsFromRequestData(): void
    {
        ...
        $this->userRank = htmlspecialchars($_POST['rank']);    
    }

    public function saveToStorage()
    { 
        $sql = "INSERT INTO users(login, user_name, user_lastname, user_birthday_timestamp, rank) VALUES (:user_login, :user_name, :user_lastname, :user_birthday, :user_rank)";
